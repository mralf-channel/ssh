...
class SSL_TLS:
	...
	def Chek(self):
		...
		while self.pilih == "":
			print(" \x1b[1;91m >>>\x1b[1;97m YANG BENER GAN\x1b[1;91m!")
			self.pilih = input("  \x1b[1;97m>>> ")
		try:
			chekin = self.link[int(self.pilih) - 1]
		except (ValueError, IndexError):
			exit("  \x1b[1;97m[\x1b[1;91m!\x1b[1;97m] MASUKAN ANGKANYA AJA GAN..")
		...
		if cek_2.find("div", class_="progress-bar progress-bar-danger") is None:
			...
			print("\x1b[1;91m+-----------------------------------+")
			user = input("  \x1b[1;91m==> \x1b[1;97mISI NAMA ENTE GAN:\x1b[1;96m ")
			pasw = input("  \x1b[1;91m==> \x1b[1;97mISI PASSWORD ENTE GAN: \x1b[1;96m")
			print("\x1b[1;91m+-----------------------------------+")
